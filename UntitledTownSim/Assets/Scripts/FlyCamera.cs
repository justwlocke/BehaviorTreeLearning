...
{
    /*
    Gotten from: https://gist.github.com/gunderson/d7f096bd07874f31671306318019d996
    ...
    // MJS - changed so you don't have to press LMB to move, added arrow keys
    ...
    public void DoCalculation()
    {
        ...
        {
            transform.Translate(p);
            if (transform.position.y < 0.25f) // don't go below ground
            {
